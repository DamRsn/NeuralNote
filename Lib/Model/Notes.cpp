                   ...
                   ConvertParams inParams)
{
    ...
    auto max_note_idx =
        (inParams.maxFrequency < 0)
            ? n_notes - 1
            : ((NoteUtils::hzToMidi(inParams.maxFrequency) - MIDI_OFFSET));
    auto min_note_idx =
        (inParams.minFrequency < 0)
            ? 0
            : ((NoteUtils::hzToMidi(inParams.minFrequency) - MIDI_OFFSET));
